          ...
          <header data-thq="thq-navbar" class="login-navbar-interactive">
            ...
            <div data-thq="thq-navbar-nav" class="login-desktop-menu">
              <nav class="login-links">
                ...
                <a href="plans.php" class="login-nav3">Plans</a>
            ...
            <div data-thq="thq-mobile-menu" class="login-mobile-menu">
              <div class="login-nav">
                ...
                <nav class="login-links1">
                  ...
                  <span class="login-nav31">Plans</span>
            ...
            <div class="login-hero1">
              <div class="login-container1">
                ...
                <input
                  ...
                  class="input login-textinput"
                />
                <label class="login-text2">Label</label>
                <div class="login-btn-group">
                  <button class="login-button button">Get Started</button>
                  <button class="login-button1 button">Learn More</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <footer class="login-footer1">
            <div class="login-container2">
              ...
              <nav class="login-nav1">
                ...
                <a href="plans.php" class="login-nav32">Plans</a>
