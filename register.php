          ...
          <div class="register-gallery1">
            <div class="register-hero1">
              <div class="register-container1">
                ...
                <label class="register-text2">Label</label>
                <input
                  type="text"
                  placeholder="placeholder"
                  class="input register-textinput"
                />
                <div class="register-btn-group">
                  <button class="register-button button">Get Started</button>
                  <button class="register-button1 button">Learn More</button>
                </div>
              </div>
            </div>
          </div>
